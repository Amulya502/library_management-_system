...
class Library:
    ...
    def add_book(self, book):
        if not isinstance(book, (Book, EBook)):
            raise TypeError("Invalid book type. Must be a Book or EBook.")
    ...
    def search_by_title(self, title):
        found_books = [book for book in self.books if isinstance(book, Book) and book.title.lower() == title.lower()]
...
# Test functionality with exception handling
try:
